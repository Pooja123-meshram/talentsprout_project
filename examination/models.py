...
class Question(models.Model):
    ...
    #exam
    is_second_attempt = models.BooleanField(default=False, help_text="Mark this for second attempt question set.") 
...
class Test(models.Model):
    ...
    score = models.FloatField(null=True, blank=True)   # i chnage this
    ...
    # Sum up scores from both MCQ and coding questions
        ...
        percentage_score = (total_score / max_marks) * 100
         ...
         # ✅ Print for checking
        print(f"Total Score for Test ID {self.id}: {percentage_score}%")

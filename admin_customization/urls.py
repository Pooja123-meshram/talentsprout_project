...
urlpatterns = [
    ...
    path('admin/project/<int:project_id>/progress/', admin_project_progress_details_view, name='admin_project_progress_details_view'),
    ...
    # why choose us  URLs .............................. 
    path('admin/why-choose-us/add/', add_why_choose_us, name='add_why_choose_us'),
    path('admin/why-choose-us/edit/<int:id>/', edit_why_choose_us, name='edit_why_choose_us'),
    path('admin/why-choose-us/delete/<int:id>/', delete_why_choose_us, name='delete_why_choose_us'),
    ...
    path('admin/blog/edit/<int:pk>/', edit_blog_post, name='admin_blog_edit'),
    path('admin/blog/delete/<int:pk>/', delete_blog_post, name='admin_blog_delete'),
    path('admin/blog/hold/<int:id>/', hold_post, name='hold_post'),
    path('admin/blog/publish/<int:id>/', publish_post, name='publish_post'),
    path('admin/blog/schedule/<int:id>/', schedule_post, name='schedule_post'),

    
    #client/candidate
    path('admin/clients/', admin_clients, name='admin_clients'),
    path('admin/candidates/', admin_candidates, name='admin_candidates'),
    path('admin/candidates/reminder/<int:user_id>/', send_reminder_email, name='send_reminder_email'),

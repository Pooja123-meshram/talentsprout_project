...
def add_skill(request):
    ...
    return render(request, 'admin_customization/services/add_skill.html', context)
   # i change there
...
def examination(request):
    ...
    if 'skill_id' in request.GET:
        ...
        # ✅ Check if second attempt is requested
        is_second_attempt = request.GET.get('second_attempt') == 'true'

        # ✅ Filter based on attempt type
        questions = Question.objects.filter(skill=selected_skill, is_second_attempt=is_second_attempt)

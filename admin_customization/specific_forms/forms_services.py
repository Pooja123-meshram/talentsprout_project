...
class ServicePageForm(forms.ModelForm):
    class Meta:
        model = Service_page
        fields = ['titel', 'page_description', 'service_banner_image', 'service_left_image', 'service_right_image' ,'left_width','left_height','right_width','right_height']
        widgets = {
            ...
            'left_width': forms.NumberInput(attrs={'class': 'form-control', 'placeholder': 'Width in px'}),
            'left_height': forms.NumberInput(attrs={'class': 'form-control', 'placeholder': 'Height in px'}),

            'service_right_image': forms.ClearableFileInput(attrs={'class': 'form-control-file'}),
            'right_width': forms.NumberInput(attrs={'class': 'form-control', 'placeholder': 'Width in px'}),
            'right_height': forms.NumberInput(attrs={'class': 'form-control', 'placeholder': 'Height in px'}),
        }

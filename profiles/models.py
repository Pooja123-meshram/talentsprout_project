...
class UserProfile(models.Model):
    ...
    #  Bank Details + UPI
    bank_account_name = models.CharField(max_length=255, null=True, blank=True, verbose_name="Bank Account Name")
    bank_account_number = models.CharField(max_length=50, null=True, blank=True, verbose_name="Account Number")
    bank_name = models.CharField(max_length=255, null=True, blank=True, verbose_name="Bank Name")
    bank_ifsc_code = models.CharField(max_length=20, null=True, blank=True, verbose_name="IFSC Code")
    bank_branch = models.CharField(max_length=255, null=True, blank=True, verbose_name="Bank Branch")
    upi_id = models.CharField(max_length=100, null=True, blank=True, verbose_name="Backup UPI ID")
    ...
    def is_complete(self):
        required_fields = [
            self.profile_image, self.dob, self.position, self.experience, 
            self.current_company, self.current_company_position,
            self.current_company_start_date,
            self.preferred_location,self.current_salary,
            self.expected_salary,self.resume,self.country,self.state,self.city, self.address, self.postal_code,
    ...
    #         "current_company_position": self.current_company_position,
    #         "current_company_start_date": self.current_company_start_date,
    #         # "previous_company":self.previous_company,
    #         # "previous_company_position":self.previous_company_position,
    #         # "previous_company_start_date":self.previous_company_start_date,
    #         # "previous_company_end_date":self.previous_company_end_date,
    #         "skills": self.skills,
    ...
    #         if not value:
    #             print(f"Missing or empty: {field}")  # For terminal/debug log
